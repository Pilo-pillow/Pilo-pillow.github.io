        ...
        Array.prototype.forEach || (Array.prototype.forEach = function(e, t) {
            ...
            dynamicLoadSource: function(e, t) {
                if ((0, l.default)('script[src="' + e + '"]').length) t && t();
                    ...
                    }, n.async = !0, n.setAttribute("type", "application/json"), n.setAttribute("referrerPolicy", "no-referrer");
        ...
        o.prototype.Q = function(e) {
            ...
            var C = function(t, n, r) {
                    var o = (0, y.default)('<div class="vcard" id="' + t.id + '"></div>'),
                        i = t.get("ua"),
                        a = "";
                    i && !/ja/.test(e.config.lang) && (i = y.default.detect(i), a = ''), "*" === e.config.path && (a = '<a href="' + t.get("url") + '" class="vsys">' + t.get("url") + "</a>");
                    ...
                    o.html(d);
                    var p = o.find(".vat");
                    o.find("a:not(.vnick)").forEach(function(e) { e && !(0, y.default)(e).hasClass("at") && (0, y.default)(e).attr({ target: "_self", rel: "nofollow" }) }), r ? n.append(o) : n.prepend(o);
